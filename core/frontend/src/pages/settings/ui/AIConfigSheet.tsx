    ...
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-6">
        ...
        <div className="space-y-4">
          <InfoRow
            label="Provider"
            value={PROVIDER_LABELS[cfg.provider] ?? cfg.provider}
          />
          <InfoRow
            label="Model"
            value={
          ...
          {cfg.base_url && (
            <InfoRow
              label="Base URL"
              value={<span className="font-mono break-all">{cfg.base_url}</span>}
            />
          )}
        </div>
      </div>
      ...
      {confirmDelete && (
        <div className="border-t px-4 py-3 bg-destructive/5 space-y-2 shrink-0">
          <div className="flex items-start gap-2 text-sm">
            ...
            <p>
              Delete <strong>{cfg.name}</strong>? This cannot be undone.
            </p>
          </div>
